...
<body>
<form id="pagerForm" method="post" action="/fr-here/rest/app/welcome/list">
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="numPerPage" value="${numPerPage}" />
</form>

<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/fr-here/rest/app/welcome/list" method="post" >
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/fr-here/rest/app/welcome/toaddorupdate?id=0" target="navTab"><span>添加图片</span></a></li>
			<li class="line">line</li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="/fr-here/rest/app/welcome/deletes" class="delete"><span>批量删除</span></a></li>
		</ul>
	</div>
	<table class="table" width="1000" layoutH="137">
		<thead>
			<tr>
				...
				<th width="100" align="center" >图片url</th>
		...
		<tbody>
			...
			<tr target="sid_user" rel="20">
				...
				<td align="center">
					<a title="确实要删除这条记录吗" target="ajaxTodo" href="/fr-here/rest/app/welcome/delete?id=${item.id}" class="btnDel">删除</a>							
					<a title="编辑" target="navTab" href="/fr-here/rest/app/welcome/toaddorupdate?id=${item.id}" class="btnEdit">编辑</a>
				</td>										
			</tr>
			</c:forEach>
		</tbody>
