...
function resetAll() {
	document.getElementById("likenewscolumnname").value = "";
}
</script>
</head>
<body>
<form id="pagerForm" method="post" action="/fr-here/rest/sys/newscolumn/list">
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="numPerPage" value="${numPerPage}" />
</form>

<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/fr-here/rest/sys/newscolumn/list" method="post" >
<div class="pageHeader">
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td>
					新闻栏目名称：<input type="text" id="likenewscolumnname" name="likename" value="${likename}"/>
				</td>
			</tr>
		</table>
		<div class="subBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/fr-here/rest/sys/newscolumn/toadd" target="navTab"><span>添加新闻栏目</span></a></li>
		</ul>
	</div>
	<table class="table" width="700" layoutH="137">
		...
		<tbody>
			...
			<tr target="sid_user" rel="20">
				...
				<td align="center">
					<a title="确实要删除这条记录吗" target="ajaxTodo" href="/fr-here/rest/sys/newscolumn/delete?id=${item.id}" class="btnDel">删除</a>							
					<a title="编辑" target="navTab" href="/fr-here/rest/sys/newscolumn/toupdate?id=${item.id}" class="btnEdit">编辑</a>
				</td>										
			</tr>
			</c:forEach>
		</tbody>
